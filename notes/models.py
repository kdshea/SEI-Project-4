...
class Note(models.Model):
  ...
  questions = models.TextField(max_length=500, default=None)
  pros = models.TextField(max_length=500, default=None)
  cons = models.TextField(max_length=500, default=None)